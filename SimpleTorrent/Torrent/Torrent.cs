...
namespace SimpleTorrent.Torrent
{
...
// bytes to string conversion
        ...
        public Torrent(string name, string location, List<FileItem> files, List<string> trackers, int pieceSize, byte[] pieceHashes = null, int blockSize = 16484, bool? isPrivate = false)
        {
            ...
            if (this.trackers != null)
            {
                ...
                {
                    Tracker tracker = new SimpleTorrent.Torrent.Tracker(url);
...
// importing/exporting
        public async static Task<Torrent> LoadFromFile(string filePath, string downloadPath)
        {
